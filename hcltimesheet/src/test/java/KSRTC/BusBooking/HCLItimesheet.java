...
public class HCLItimesheet {
	  ...
	  public void MyHCL() throws InterruptedException {
	      ...
	      WebDriver driver =new ChromeDriver();
			      ...
			      WebElement TimeEnter=driver.findElement(By.xpath("//input[@class='form-control enterTime ng-pristine ng-valid ng-scope ng-empty ng-valid-maxlength ng-touched']"));
